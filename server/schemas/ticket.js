...
const ticketSchema = z.object({
    title: z.string().min(30, "Title must be at least 30 characters").max(200, "Title must be less than 40 characters"),
    summary: z.string().min(100, "Summary must be at least 100 characters").max(400, "Summary must be less than 500 characters"),
    ...
    relevantUserinfo: z.string().min(100).max(400),
    spam: z.boolean()
});
